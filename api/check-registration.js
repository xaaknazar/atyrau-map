...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        var systemPrompt = [
            ...
            "- ст.188 — кража (тайное хищение); ст.189 — присвоение/растрата; ст.190 — мошенничество; ст.191 — грабёж (открытое хищение, в т.ч. с насилием, НЕ опасным для жизни/здоровья); ст.192 — разбой (нападение с насилием, ОПАСНЫМ для жизни/здоровья, либо с применением/угрозой оружия).",
            "",
