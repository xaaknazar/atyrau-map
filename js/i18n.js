...
var I18N = {
    ru: {
        ...
        av_show_all: "Показывать всех (включая однократные)",
        ...
        av_youth_hint: "Лица в возрасте 18–27 лет, неоднократно совершившие административные правонарушения. По каждому: сколько раз, какие статьи и доступные личные данные.",
    ...
    kz: {
        ...
        av_show_all: "Барлығын көрсету (бір реттікті қоса)",
        ...
        av_youth_hint: "18–27 жас аралығындағы, әкімшілік құқық бұзушылықты бірнеше рет жасаған тұлғалар. Әрқайсысы бойынша: неше рет, қандай баптар және қолжетімді жеке деректер.",
