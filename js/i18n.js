...
var I18N = {
    ru: {
        brief_summary_ru: "Сводка",
        brief_public_short: "Общ. места",
        brief_coords_short: "С коорд.",
        brief_period: "Период данных",
        brief_priority: "Приоритетные проблемы",
        brief_priority_hint: "Система выделила самые значимые проблемы. По каждой можно сформировать акт надзора.",
        brief_download_usynu: "Сформировать ҰСЫНУ",
        on_map: "На карте",
        nav_priority: "Приоритеты",
        nav_recs: "Рекомендации",
        nav_articles: "Статьи",
        nav_geo: "Зоны",
        nav_hot: "Очаги",
        nav_time: "Время",
        ...
        report_btn: "Отчет",
        cat_cameras: "Камеры",
        cat_alkomarkets: "Алкомаркеты",
        stat_cameras: "Камеры:",
        zones_legend_title: "Очаги преступности",
        back_to_map: "Назад к карте",
        back_label: "Назад",
        rs_title: "Отчёты и аналитика",
        report_org_sub: "Прокуратура города Атырау",
        rs_sec_erdr: "Уголовные правонарушения (ЕРДР)",
        rs_sec_av: "Административные правонарушения",
        rs_sec_nadzor: "Прокурорский надзор",
        rc_reg_erdr_t: "Реестр правонарушений",
        rc_reg_erdr_d: "Зарегистрированные уголовные правонарушения",
        rc_an_erdr_t: "Аналитика преступлений",
        rc_an_erdr_d: "Статистический анализ и ИИ-помощник прокурора",
        rc_reg_av_t: "Реестр правонарушений",
        rc_reg_av_d: "Список административных правонарушений",
        rc_an_av_t: "Аналитика правонарушений",
        rc_an_av_d: "Статистический анализ административных правонарушений",
        rc_reg_check_t: "Контроль регистраций",
        rc_reg_check_d: "Проверка качества: соответствие фабулы статье (AI), полнота, даты, дубликаты, язык",
        lbl_sort: "Сортировка:",
        sort_new: "Сначала новые",
        sort_old: "Сначала старые",
        sort_article: "По статье",
        lbl_article: "Статья:",
        lbl_organ: "Орган:",
        opt_all_organs: "Все органы",
        lbl_place: "Место:",
        lbl_public: "Общ. место:",
        opt_yes: "Да",
        opt_no: "Нет",
        btn_export: "Выгрузить",
        btn_reset: "Сбросить фильтры",
        cp_stat_total: "Всего",
        cp_stat_public: "Общественные места",
        cp_stat_coords: "С координатами",
        cp_stat_uniq: "Уник. статей",
        cp_stat_inspectors: "Инспекторов",
        av_panel_title: "Административные правонарушения",
        rc_hint: "Надзор за качеством регистрации: соответствие описания указанной статье (на русском и казахском), полнота полей, корректность дат, дубликаты и язык описания.",
        rc_ai_btn: "Проверить соответствие статье (AI)",
        rc_ai_recheck: "Перепроверить заново",
        rc_search_ph: "Поиск по статье (например: 188 или ст.190 ч.4)",
        rc_f_issues: "С замечаниями",
        rc_f_all: "Все",
        rc_f_complete: "Полнота",
        rc_f_date: "Даты",
        rc_f_dup: "Дубликаты",
        rc_f_lang: "Язык",
        rc_f_ai: "AI: несоответствия",
        rc_recs_word: "записей",
        av_unit_label: "Подразделение:",
        av_inspector_label: "Инспектор:",
        shown_label: "Показано:",
        av_an_title: "Аналитика административных правонарушений",
        av_persons_title: "Лица — потенциальные нарушители",
        av_persons_hint: "Лица, неоднократно совершившие административные правонарушения по статьям, сопряжённым с риском перехода в уголовную ответственность. Прокуроры могут видеть потенциальных нарушителей.",
        av_tab_transport: "Транспортные",
        av_tab_personal: "Против личности",
        av_tab_family: "Семейно-бытовые",
        av_show_all: "Показывать всех (включая с 1–4 нарушениями)",
        av_h_authors: "Топ инспекторов по количеству протоколов",
        av_h_units: "По подразделениям",
        av_h_articles: "Топ статей",
        av_h_raions: "По районам",
        av_h_state: "Состояние нарушителя",
        av_h_age: "По возрасту",
        av_h_months: "По месяцам",
        av_youth_title: "Молодёжь 18–27, часто нарушающие",
        av_youth_hint: "Лица в возрасте 18–27 лет, совершившие 5 и более административных правонарушений (часто нарушающие, отмечены красным). По каждому: сколько раз, какие статьи и доступные личные данные.",
        ...
        police_login_error: "Неверный пароль",
        ...
        brief_geo_hint: "Группировка по координатам (радиус ~1000м) — не зависит от названия улиц",
        brief_zone: "Район",
        ...
        brief_all_persons: "Все лица",
        brief_search_person: "Поиск по ФИО...",
    ...
    kz: {
        brief_summary_ru: "Қысқаша мәлімет",
        brief_public_short: "Қоғ. орын",
        brief_coords_short: "Координатамен",
        brief_period: "Деректер кезеңі",
        brief_priority: "Басым мәселелер",
        brief_priority_hint: "Жүйе ең маңызды мәселелерді бөліп көрсетті. Әрқайсысы бойынша қадағалау актісін дайындауға болады.",
        brief_download_usynu: "ҰСЫНУ жүктеу",
        on_map: "Картада",
        nav_priority: "Басымдықтар",
        nav_recs: "Ұсынымдар",
        nav_articles: "Баптар",
        nav_geo: "Аймақтар",
        nav_hot: "Ошақтар",
        ...
        report_btn: "Есеп",
        cat_cameras: "Камералар",
        cat_alkomarkets: "Алкомаркеттер",
        stat_cameras: "Камералар:",
        zones_legend_title: "Қылмыс ошақтары",
        back_to_map: "Картаға оралу",
        back_label: "Артқа",
        rs_title: "Есептер мен талдау",
        report_org_sub: "Атырау қаласының прокуратурасы",
        rs_sec_erdr: "Қылмыстық құқық бұзушылықтар (ЕРДР)",
        rs_sec_av: "Әкімшілік құқық бұзушылықтар",
        rs_sec_nadzor: "Прокурорлық қадағалау",
        rc_reg_erdr_t: "Құқық бұзушылықтар тізілімі",
        rc_reg_erdr_d: "Тіркелген қылмыстық құқық бұзушылықтар",
        rc_an_erdr_t: "Қылмыстар талдауы",
        rc_an_erdr_d: "Статистикалық талдау және прокурордың ЖИ-көмекшісі",
        rc_reg_av_t: "Құқық бұзушылықтар тізілімі",
        rc_reg_av_d: "Әкімшілік құқық бұзушылықтар тізімі",
        rc_an_av_t: "Құқық бұзушылықтар талдауы",
        rc_an_av_d: "Әкімшілік құқық бұзушылықтардың статистикалық талдауы",
        rc_reg_check_t: "Тіркеулерді бақылау",
        rc_reg_check_d: "Сапаны тексеру: фабуланың бапқа сәйкестігі (AI), толықтық, күндер, телнұсқалар, тіл",
        lbl_sort: "Сұрыптау:",
        sort_new: "Алдымен жаңалары",
        sort_old: "Алдымен ескілері",
        sort_article: "Бап бойынша",
        lbl_article: "Бап:",
        lbl_organ: "Орган:",
        opt_all_organs: "Барлық органдар",
        lbl_place: "Орын:",
        lbl_public: "Қоғ. орын:",
        opt_yes: "Иә",
        opt_no: "Жоқ",
        btn_export: "Жүктеу",
        btn_reset: "Сүзгілерді тазарту",
        cp_stat_total: "Барлығы",
        cp_stat_public: "Қоғамдық орындар",
        cp_stat_coords: "Координаталармен",
        cp_stat_uniq: "Бірегей баптар",
        cp_stat_inspectors: "Инспекторлар",
        av_panel_title: "Әкімшілік құқық бұзушылықтар",
        rc_hint: "Тіркеу сапасын қадағалау: сипаттаманың көрсетілген бапқа сәйкестігі (орыс және қазақ тілінде), өрістердің толықтығы, күндердің дұрыстығы, телнұсқалар және сипаттама тілі.",
        rc_ai_btn: "Бапқа сәйкестігін тексеру (AI)",
        rc_ai_recheck: "Қайта тексеру",
        rc_search_ph: "Бап бойынша іздеу (мысалы: 188 немесе 190-бап 4-б.)",
        rc_f_issues: "Ескертулермен",
        rc_f_all: "Барлығы",
        rc_f_complete: "Толықтық",
        rc_f_date: "Күндер",
        rc_f_dup: "Телнұсқалар",
        rc_f_lang: "Тіл",
        rc_f_ai: "AI: сәйкессіздіктер",
        rc_recs_word: "жазба",
        av_unit_label: "Бөлімше:",
        av_inspector_label: "Инспектор:",
        shown_label: "Көрсетілді:",
        av_an_title: "Әкімшілік құқық бұзушылықтар талдауы",
        av_persons_title: "Тұлғалар — әлеуетті құқық бұзушылар",
        av_persons_hint: "Қылмыстық жауапкершілікке ұласу қаупі бар баптар бойынша әкімшілік құқық бұзушылықты бірнеше рет жасаған тұлғалар. Прокурорлар әлеуетті құқық бұзушыларды көре алады.",
        av_tab_transport: "Көліктік",
        av_tab_personal: "Жеке тұлғаға қарсы",
        av_tab_family: "Отбасылық-тұрмыстық",
        av_show_all: "Барлығын көрсету (1–4 бұзушылықты қоса)",
        av_h_authors: "Хаттама саны бойынша үздік инспекторлар",
        av_h_units: "Бөлімшелер бойынша",
        av_h_articles: "Үздік баптар",
        av_h_raions: "Аудандар бойынша",
        av_h_state: "Құқық бұзушының жағдайы",
        av_h_age: "Жасы бойынша",
        av_h_months: "Айлар бойынша",
        av_youth_title: "18–27 жастағы жиі бұзушы жастар",
        av_youth_hint: "18–27 жас аралығындағы, 5 және одан көп әкімшілік құқық бұзушылық жасаған тұлғалар (жиі бұзушылар, қызылмен белгіленген). Әрқайсысы бойынша: неше рет, қандай баптар және қолжетімді жеке деректер.",
        ...
        police_login_error: "Құпия сөз қате",
        ...
        brief_geo_hint: "Координаталар бойынша топтау (радиус ~1000м) — көше атауларына тәуелді емес",
        brief_zone: "Аймақ",
        ...
        brief_all_persons: "Барлық тұлғалар",
        brief_search_person: "ТАЖ бойынша іздеу...",
